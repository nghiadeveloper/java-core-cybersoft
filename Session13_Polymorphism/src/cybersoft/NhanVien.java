...
public class NhanVien implements TinhNang, TinhNang2 {
	...
	public void chamCong() {
		double luong = this.luong * 30;
		System.out.println("Tính lương nhân viên: " + luong);
	}

	@Override
	public void tinhLuongThangMuoiBa() {
		System.out.println("Tính lương tháng 13");
	}
